...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	self.viewController = [[AecountViewController alloc] initWithNibName:@"AecountViewController" bundle:nil];
	self.viewController.countManager = countManager;
